$(document).ready(function() {
    ...
    /* new upates 04-08-2021 */
     $(document).on('click', '.allow-focus', function (e) {
       e.stopPropagation();
     });
     $(".checkAll").click(function () {
        $(this).parents().eq(4).find(".checkbox .check").prop('checked', true);
        $(this).parents().eq(4).find("li").addClass("active");
    });
    $(".unCheckAll").click(function () {
        $(this).parents().eq(4).find(".checkbox .check").prop('checked', false);
        $(this).parents().eq(4).find("li").removeClass("active");
       
    });
     $(".checkbox-menu .dropdown .checkbox").on("change", "input[type='checkbox']", function() {
