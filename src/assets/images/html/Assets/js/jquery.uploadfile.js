...
(function ($) {
    ...
    $.fn.uploadFile = function (options) {
        ...
        var s = $.extend({
            ...
            uploadStr:"Drop files here to upload",
            abortStr: "Abort",
            cancelStr: "Cancel",
            deleteStr: "Delete",
            doneStr: "Done",
	...
	this.enqueueFile = function(file){
		...
		function defaultProgressBar(obj,s)
		{
            ...
            this.preview = $("<img class='ajax-file-upload-preview' />").width(s.previewWidth).height(s.previewHeight).appendTo(this.statusbar).wrap("<div class='upload-preview-wrap'></div>").hide();
